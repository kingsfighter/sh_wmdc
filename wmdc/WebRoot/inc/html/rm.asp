...
<BODY bgColor=#D9E6FF topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
<form name=rm>
...
循环：<select id=c><option value="-1">是<option value="0">否</select><br>
播放位置：<select id=d><option value="left">居左<option value="center">居中<option value="right">居右</select>
显示：<select id=h><option value="0">只是音乐<option value="1">显示视频</select><br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button value='插入' id=Ok title='点击“插入”按钮，在编辑器中插入该RealPlay文件'></form>
